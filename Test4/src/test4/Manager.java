...
public class Manager {
    ...
    public static int countLine() {
        int countLine = 0;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/test4/input.txt")));
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("src/test4/output.txt", true)));
            String line;
